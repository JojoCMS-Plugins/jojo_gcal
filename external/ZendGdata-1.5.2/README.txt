Welcome to Zend Gdata 1.5.2! This is a maintenance release of the 
Zend Gdata 1.5 series. This release maintains backwards compatibility with
the Zend Gdata 1.0 series and has been rigorously tested with many
...
Zend Gdata 1.5.2 (revision 9458).
...
Zend Gdata requires PHP 5.1.4 or later. Please see our reference guide for
...
its documented behavior, please create an issue in the Zend Gdata issue
tracker at:

http://framework.zend.com/issues

If you would like to be notified of new releases- including further maintenance 
releases for Zend Gdata 1.5- you can subscribe to the fw-announce mailing list
by sending a blank message to fw-announce-subscribe@lists.zend.com.

LICENSE
-------

The files in this archive are released under the Zend Gdata license. You can
find a copy of this license in /LICENSE.txt.

ACKNOWLEDGEMENTS
----------------

The Zend Gdata team would like to thank all the contributors to the Zend
